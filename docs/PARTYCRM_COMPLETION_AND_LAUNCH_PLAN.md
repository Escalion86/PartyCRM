...
- [ ] Привязать feature flags к тарифам полностью: расширить Google Calendar до полноценного OAuth/sync flow и добавить API-enforcement во всех будущих доменных endpoints.
