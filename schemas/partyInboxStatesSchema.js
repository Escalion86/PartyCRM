...
const partyInboxStatesSchema = {
  ...
  salesStage: { type: String, enum: ['new', 'qualification', 'proposal', 'negotiation', 'won', 'lost'], default: 'new' },
  lostReason: { type: String, default: '', maxlength: 1000 },
  ...
  history: { type: [{
    type: { type: String, enum: ['sla_started', 'sla_answered', 'handoff_proposed', 'handoff_accepted', 'handoff_canceled', 'sales_stage_changed'], required: true },
    fromSalesStage: { type: String, default: '' },
    toSalesStage: { type: String, default: '' },
    lostReason: { type: String, default: '', maxlength: 1000 },
